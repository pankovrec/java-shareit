...
public class BookingServiceIntegralTest {
    ...
    public void getAllByUserStateWaiting() {
        ...
        OutBookingDto.User booker = new OutBookingDto.User(1);
        booking.setBooker(booker);
        List<OutBookingDto> bookingList = bookingService.getAllBookingByUser(user1.getId(), State.WAITING, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
    ...
    public void getAllByUserStateRejected() {
        ...
        List<OutBookingDto> bookingList = bookingService.getAllBookingByUser(user1.getId(), State.REJECTED, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
    ...
    public void getAllByOwner() {
        ...
        OutBookingDto.User booker = new OutBookingDto.User(1);
        booking.setBooker(booker);
        List<OutBookingDto> bookingList = bookingService.getAllBookingByOwner(user2.getId(), State.ALL, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
    ...
    public void getAllByOwnerStatePast() {
        ...
        OutBookingDto.User booker = new OutBookingDto.User(1);
        booking.setBooker(booker);
        List<OutBookingDto> bookingList = bookingService.getAllBookingByOwner(user2.getId(), State.PAST, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
    ...
    public void getAllByOwnerStateCurrent() {
        ...
        OutBookingDto.User booker = new OutBookingDto.User(1);
        booking.setBooker(booker);
        List<OutBookingDto> bookingList = bookingService.getAllBookingByOwner(user2.getId(), State.CURRENT, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
    ...
    public void getAllByOwnerStateWaiting() {
        ...
        OutBookingDto.User booker = new OutBookingDto.User(1);
        booking.setBooker(booker);
        List<OutBookingDto> bookingList = bookingService.getAllBookingByOwner(user2.getId(), State.WAITING, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
    ...
    public void getAllByOwnerStateRejected() {
        ...
        booking.setStatus(Status.REJECTED);
        bookingService.updateBookingStatus(1, false, 2);
        List<OutBookingDto> bookingList = bookingService.getAllBookingByOwner(user2.getId(), State.REJECTED, 0,
                5);
        assertThat(bookingList.get(0).toString(), equalTo(booking.toString()));
    }
}
